...
const linkverificacion = `http://${IPV4}:5173/profile/validation/`;
...
const sendVerificationMail = async (email, verificationCode, link) => {
  ...
  <!--[if !mso]><!--><td class="t15" style="width:465px;padding:0 15px 0 0;">
  <!--<![endif]-->
  <!--[if mso]><td class="t15" style="width:480px;padding:0 15px 0 0;"><![endif]-->
  </td>
  </tr></table>
  ...
  <p class="t53" style="margin:0;Margin:0;font-family:BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif,'Albert Sans';line-height:21px;font-weight:400;font-style:normal;font-size:16px;text-decoration:none;text-transform:none;letter-spacing:-0.64px;direction:ltr;color:#333333;text-align:left;mso-line-height-rule:exactly;mso-text-raise:2px;">Para completar el proceso de registro y activar tu cuenta en RetroShop, simplemente haz clic en el siguiente botón:</p></td>
  </tr></table>
  ...
  <!--[if !mso]><!--><td class="t35" style="background-color:#92003C;overflow:hidden;width:179px;text-align:center;line-height:34px;mso-line-height-rule:exactly;mso-text-raise:6px;border-radius:40px 40px 40px 40px;">
  <!--<![endif]-->
  <!--[if mso]><td class="t35" style="background-color:#92003C;overflow:hidden;width:179px;text-align:center;line-height:34px;mso-line-height-rule:exactly;mso-text-raise:6px;border-radius:40px 40px 40px 40px;"><![endif]-->
  <a class="t41" href="${link}" style="display:block;margin:0;Margin:0;font-family:BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif,'Inter Tight';line-height:34px;font-weight:900;font-style:normal;font-size:13px;text-decoration:none;text-transform:uppercase;direction:ltr;color:#FFFFFF;text-align:center;mso-line-height-rule:exactly;mso-text-raise:6px;" target="_blank">ACTIVAR CUENTA</a></td>
  </tr></table>
  ...
  <p class="t63" style="margin:0;Margin:0;font-family:BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif,'Albert Sans';line-height:21px;font-weight:400;font-style:normal;font-size:16px;text-decoration:none;text-transform:none;letter-spacing:-0.64px;direction:ltr;color:#333333;text-align:left;mso-line-height-rule:exactly;mso-text-raise:2px;">Una vez que hayas activado tu cuenta, estarás listo para sumergirte en nuestro catálogo de productos retro y revivir esos momentos especiales del pasado.</p></td>
  </tr></table>
  </td></tr><tr><td><div class="t84" style="mso-line-height-rule:exactly;mso-line-height-alt:35px;line-height:35px;font-size:1px;display:block;">&nbsp;</div></td></tr><tr><td>
  <table class="t86" role="presentation" cellpadding="0" cellspacing="0" align="center"><tr>
  ...
  await sendMail(email, "Verificacion de cuenta", link, customHtml);
};
